...
INSERT INTO ejemplares VALUES
	(nextval('ejemplares_sequence'), 1, 'azul', 25000, 32000, '2019-03-13', 2, 96),
	(nextval('ejemplares_sequence'), 1, 'rojo', 23000, 32000, '2018-09-15', 5, 120),
	(nextval('ejemplares_sequence'), 2, 'verde', 21000, 32000, '2017-10-27', 7, 98),
	(nextval('ejemplares_sequence'), 2, 'negro', 75000, 95000, '2019-05-14', 24, 75),
	(nextval('ejemplares_sequence'), 3, 'blanco', 70000, 95000, '2016-12-23', 28, 55),
	(nextval('ejemplares_sequence'), 3, 'rojo', 77000, 96000, '2017-04-17', 3, 57),
	(nextval('ejemplares_sequence'), 4, 'amarillo', 52000, 67000, '2019-02-25', 6, 38),
	(nextval('ejemplares_sequence'), 4, 'violeta', 51000, 66000, '2011-08-14', 4, 28),
	(nextval('ejemplares_sequence'), 5, 'violeta', 50000, 66000, '2012-11-15', 9, 21),
	(nextval('ejemplares_sequence'), 5, 'cafe', 33000, 41000, '2018-05-20', 17, 34),	
	(nextval('ejemplares_sequence'), 7, 'azul', 27000, 35000, '2017-04-13', 19, 46),
	(nextval('ejemplares_sequence'), 8, 'rojo', 23000, 36000, '2015-02-24', 15, 27),
	(nextval('ejemplares_sequence'), 9, 'verde', 35000, 48000, '2014-01-14', 2, 35),
	(nextval('ejemplares_sequence'), 2, 'negro', 95000, 158000, '2011-10-09', 1, 59),
	(nextval('ejemplares_sequence'), 12, 'blanco', 19000, 47000, '2010-12-10', 3, 53),
	(nextval('ejemplares_sequence'), 1, 'rojo', 78000, 85000, '2018-11-28', 1, 40),
	(nextval('ejemplares_sequence'), 2, 'amarillo', 65000, 79000, '2018-04-17', 25, 58),
	(nextval('ejemplares_sequence'), 8, 'violeta', 34000, 69000, '2019-09-26', 27, 29),
	(nextval('ejemplares_sequence'), 8, 'violeta', 44000, 88000, '2019-02-24', 23, 80),
	(nextval('ejemplares_sequence'), 9, 'cafe', 36000, 75000, '2019-01-18', 21, 36),	
	(nextval('ejemplares_sequence'), 10, 'azul', 29000, 36000, '2017-08-13', 19, 100),
	(nextval('ejemplares_sequence'), 12, 'rojo', 12000, 54000, '2016-02-16', 12, 25),
	(nextval('ejemplares_sequence'), 12, 'verde', 64000, 125000, '2014-01-04', 7, 70),
	(nextval('ejemplares_sequence'), 2, 'negro', 77000, 180000, '2015-03-02', 9, 35),
	(nextval('ejemplares_sequence'), 13, 'blanco', 95000, 235000, '2015-10-13', 14, 45),
	(nextval('ejemplares_sequence'), 3, 'rojo', 84000, 165000, '2015-12-13', 13, 23),
	(nextval('ejemplares_sequence'), 4, 'amarillo', 56000, 168000, '2019-07-29', 23, 10),
	(nextval('ejemplares_sequence'), 6, 'violeta', 17000, 49000, '2011-04-25', 26, 80),
	(nextval('ejemplares_sequence'), 7, 'violeta', 46000, 85000, '2011-01-27', 17, 49),
	(nextval('ejemplares_sequence'), 9, 'cafe', 38000, 95000, '2016-08-13', 29, 54);
...
INSERT INTO ventas VALUES
	(nextval('ventas_sequence'), '1324546579', '1144208998', '2018-03-23 19:54:25-01'),
	(nextval('ventas_sequence'), '1324546579', '4486351344', '2017-05-25 15:12:25-02'),
	(nextval('ventas_sequence'), '1324546579', '4486351344', '2015-03-15 19:10:25-05'),
	(nextval('ventas_sequence'), '2342176325', '4486351344', '2015-05-15 19:15:25-04'),
	(nextval('ventas_sequence'), '2342176325', '1144208998', '2014-03-14 18:10:25-04'),
	(nextval('ventas_sequence'), '2342176325', '1134678455', '2017-03-07 19:17:25-08'),
	(nextval('ventas_sequence'), '2342176325', '1134678455', '2019-07-05 19:10:25-07'),
	(nextval('ventas_sequence'), '2342176325', '1134678455', '2015-03-13 19:26:25-02'),
	(nextval('ventas_sequence'), '1324546579', '2522486655', '2011-12-08 19:10:25-03'),
	(nextval('ventas_sequence'), '4473215382', '5434643581', '2012-10-13 19:25:25-04'),
	(nextval('ventas_sequence'), '4473215382', '5434643581', '2013-08-14 18:10:25-09'),
	(nextval('ventas_sequence'), '1324546579',  '5434643581', '2018-07-13 19:54:25-05'),
	(nextval('ventas_sequence'), '4473215382', '2522486655', '2016-06-17 19:10:25-07'),
	(nextval('ventas_sequence'), '4473215382', '2522486655', '2018-07-17 17:14:25-01'),
	(nextval('ventas_sequence'), '1324546579', '1144208998', '2014-05-13 19:10:25-07'),
	(nextval('ventas_sequence'), '4473215382', '5746868455', '2018-09-27 19:45:25-10'),
	(nextval('ventas_sequence'), '1324546579', '2522486655', '2017-12-13 14:10:25-09'),
	(nextval('ventas_sequence'), '1324546579', '1144208998', '2015-10-31 19:19:25-07'),
	(nextval('ventas_sequence'), '2354382341', '2522486655', '2011-01-13 19:10:25-04'),
	(nextval('ventas_sequence'), '1324546579', '1144208998', '2012-01-25 22:08:25-05'),
	(nextval('ventas_sequence'), '1324546579',  '2522486655', '2013-07-13 19:10:25-07'),
	(nextval('ventas_sequence'), '2354382341', '5746868455', '2009-04-14 19:10:25-03'),
	(nextval('ventas_sequence'), '2354382341', '5746868455', '2010-05-11 19:10:25-07'),
	(nextval('ventas_sequence'), '2354382341', '5746868455', '2011-08-15 15:10:25-05'),
	(nextval('ventas_sequence'), '2354382341', '5746868455', '2010-11-18 19:11:25-07'),
	(nextval('ventas_sequence'), '1324546579', '5746868455', '2010-12-11 19:12:25-08'),
	(nextval('ventas_sequence'), '2354382341', '1144208998', '2009-10-08 17:10:25-07'),
	(nextval('ventas_sequence'), '2354382341', '5746868455', '2009-09-07 18:18:25-04'),
	(nextval('ventas_sequence'), '2354382341', '5746868455', '2017-07-09 17:15:25-07'),
	(nextval('ventas_sequence'), '1324546579', '5746868455', '2018-03-03 18:10:25-05'),
	(nextval('ventas_sequence'), '1324546579', '3346466456', '2019-08-13 19:10:21-07');
